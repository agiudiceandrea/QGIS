...
def test_012_read_wkt_point():
    wanted = {}
    wanted["uri"] = (
        "file://testwkt.csv?geomType=point&delimiter=|&type=csv&wktField=geom_wkt"
    )
    wanted["fieldTypes"] = ["integer", "text"]
    wanted["geometryType"] = 0
    wanted["data"] = {
...
def test_013_read_wkt_line():
    wanted = {}
    wanted["uri"] = (
        "file://testwkt.csv?geomType=line&delimiter=|&type=csv&wktField=geom_wkt"
    )
    wanted["fieldTypes"] = ["integer", "text"]
...
def test_014_read_wkt_polygon():
    wanted = {}
    wanted["uri"] = (
        "file://testwkt.csv?geomType=polygon&delimiter=|&type=csv&wktField=geom_wkt"
    )
    wanted["fieldTypes"] = ["integer", "text"]
...
def test_016_decimal_point():
    wanted = {}
    wanted["uri"] = (
        "file://testdp.csv?yField=geom_y&xField=geom_x&type=csv&delimiter=;&decimalPoint=,"
    )
...
def test_017_regular_expression_1():
    wanted = {}
    wanted["uri"] = (
        "file://testre.txt?geomType=none&trimFields=Y&delimiter=RE(?:GEXP)?&type=regexp"
    )
    wanted["fieldTypes"] = ["integer", "text", "text", "text"]
    wanted["geometryType"] = 4
    wanted["data"] = {
...
def test_019_regular_expression_3():
    wanted = {}
    wanted["uri"] = (
        "file://testre2.txt?geomType=none&trimFields=Y&delimiter=^(.{5})(.{30})(.{5,})&type=regexp"
    )
    wanted["fieldTypes"] = ["integer", "text", "text"]
    wanted["geometryType"] = 4
    wanted["data"] = {
...
def test_022_utf8_encoded_file():
    wanted = {}
    wanted["uri"] = (
        "file://testutf8.csv?geomType=none&delimiter=|&type=csv&encoding=utf-8"
    )
    wanted["fieldTypes"] = ["integer", "text", "text"]
    wanted["geometryType"] = 4
    wanted["data"] = {
...
def test_023_latin1_encoded_file():
    wanted = {}
    wanted["uri"] = (
        "file://testlatin1.csv?geomType=none&delimiter=|&type=csv&encoding=latin1"
    )
    wanted["fieldTypes"] = ["integer", "text", "text"]
    wanted["geometryType"] = 4
    wanted["data"] = {
...
def test_028_substring_test():
    wanted = {}
    wanted["uri"] = (
        "file://test.csv?geomType=none&type=csv&subset=id%20%25%202%20%3D%201"
    )
    wanted["fieldTypes"] = ["integer", "text", "text", "text", "text"]
    wanted["geometryType"] = 4
    wanted["data"] = {
...
def test_030_filter_rect_xy_spatial_index():
    wanted = {}
    wanted["uri"] = (
        "file://testextpt.txt?spatialIndex=Y&yField=y&delimiter=|&type=csv&xField=x"
    )
    wanted["fieldTypes"] = ["integer", "text", "integer", "integer"]
    wanted["geometryType"] = 0
    wanted["data"] = {
...
def test_031_filter_rect_wkt_spatial_index():
    wanted = {}
    wanted["uri"] = (
        "file://testextw.txt?spatialIndex=Y&delimiter=|&type=csv&wktField=wkt"
    )
    wanted["fieldTypes"] = ["integer", "text"]
    wanted["geometryType"] = 1
    wanted["data"] = {
